...
param appServicePlan_location string
param appService_web_name string
...
resource appServiceWeb_resource 'Microsoft.Web/sites@2022-09-01' = {
  ...
  properties: {
    ...
    hostNameSslStates: [
      {
        name: '${appService_web_name}.azurewebsites.net'
        sslState: 'Disabled'
        hostType: 'Standard'
      }
    ]
...
resource sites_appServiceWeb_config 'Microsoft.Web/sites/config@2022-09-01' = {
  parent: appServiceWeb_resource
  name: 'web'
  properties: {
    numberOfWorkers: 1
    defaultDocuments: [
